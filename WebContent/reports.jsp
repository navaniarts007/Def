    ...
    <div class="card shadow" style="min-height: 90vh">
        <div class="card-body">
			...
			<table class="table table-bordered table-sm">
				...
				<tbody>
					<%
					List<Map<String,String>> data=DbHelper.executeDQL("select count(t.pid) as total,p.id,p.title as ptitle,p.status,p.mgrid,p.createdon,p.active from tasks t right join task_groups p on p.id=t.pid WHERE 1=? group by p.id", "1");
