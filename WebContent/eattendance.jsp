        	...
        	<div class="form-row">
      		<div class="col-sm-5">
      			<table class="table">
					...
					String sql="select id,title,mgrid from task_group WHERE id=?";
...
<div class="modal fade" id="attendance">
	<div class="modal-dialog">
		<form class="modal-content" method="post" action="attendance">			
			...
			<div class="modal-body">
				...
				<div class="form-group form-row">
					<label class="col-sm-4">Log In / Out</label>
					<div class="col-sm-8">
    ...
    <div class="col-sm-8">
        <input type="text" id="logtime" name="logtime" readonly class="form-control form-control-sm">
    </div>
</div>				
			</div>
...
<script>
    // Function to set the current system time in the "Log Time" field
    function setLogTime() {
        const now = new Date();
        const hours = now.getHours();
        const minutes = now.getMinutes();
        const formattedTime = `${hours}:${minutes < 10 ? '0' : ''}${minutes}`;
        document.getElementById("logtime").value = formattedTime;
    }
