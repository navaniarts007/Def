...
String uid="",pid=session.getAttribute("pid").toString();
    ...
    <div class="card shadow" style="min-height: 90vh">
        <div class="card-body">
        	...
        	<form class="form-inline float-right">
        		...
        		<select name="uid" class="form-control form-control-sm mr-2">
        	...
        	<div class="form-row">
      		<div class="col-sm-5">
      			<table class="table">
					...
					for(Map<String,String> row : data) { %>
      					<tr>
      						<th><%= row.get("title") %></th>
      						<th><%= TMHelper.getUserName(uid) %></th>
      		...
      		<div class="col-sm-7" id="details">
      			<table class="table table-sm">
					...
					List<Map<String,String>> edata=DbHelper.executeDQL(sql, uid,month,year);
					for(Map<String,String> row : edata) { %>
      					<tr>
