...
<div class="container-fluid p-2">
	<div class="card shadow" style="min-height: 88vh">
		...
		<div class="row">
		<%
		List<Map<String,String>> rows=DbHelper.executeDQL("select ifnull(count(t.id),0) as total,p.id,p.title as ptitle,p.status,p.mgrid from tasks t right join task_group p on p.id=t.pid WHERE p.mgrid=? group by p.id", session.getAttribute("id").toString());
