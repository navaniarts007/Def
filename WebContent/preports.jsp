    ...
    <div class="card shadow" style="min-height: 90vh">
        <div class="card-body">
			...
			<table class="table table-bordered table-sm">
				...
				<tbody>
					<%
					List<Map<String,String>> data=DbHelper.executeDQL("select count(t.id) as total,p.id,p.title as ptitle,p.status,p.mgrid from tasks t right join task_group p on p.id=t.pid WHERE p.mgrid=? group by t.pid", session.getAttribute("id").toString());
