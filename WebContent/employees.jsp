										...
										<div class="modal-body">
											<div class="form-group">
												<label>User Name</label> <input type="text" name="uname"
													required value="<%=row.get("full_name")%>"
											...
											<div class="form-group">
												<label>department</label> <select name="designation"
													required class="form-control form-control-sm">
													<option value="">--- Select Role ---</option>
													<%
														for (Map<String, String> sts : TMHelper.getMastersList("department")) {
													%>
													<option <%=row.get("department").equals(sts.get("id")) ? "selected" : ""%> value="<%=sts.get("id")%>"><%=sts.get("mastername")%></option>
													<%
														}
													%>
												</select>
