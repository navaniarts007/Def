    ...
    <div class="card shadow" style="min-height: 90vh">
        <div class="card-body">
			...
			<table class="table table-sm">
				...
				<tbody>
					<%
					List<Map<String,String>> data=DbHelper.executeDQL("select t.id,t.title,p.title as ptitle,t.status,t.uid,t.priority,p.abbr,t.createdon from tasks t join task_group p on t.pid=p.id WHERE t.uid=? and t.status!='Done'", session.getAttribute("id").toString());
